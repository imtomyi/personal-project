...
type WorkspaceListProps = {
  ...
  /** 부모에게 워크스페이스 생성 알림 (즉시 목록 반영용) */
  onWorkspaceCreated?: (ws: Workspace) => void;
};

export default function WorkspaceList({ layout = "grid", wsProgress, workspaceColors, wsNextTodo, onArchive, filterWorkspaces, onWorkspaceCreated }: WorkspaceListProps) {
